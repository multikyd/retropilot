...
static void update_state(UIState *s) {
  ...
  if (sm.updated("deviceState")) {
    ...
    scene.cpuPerc = (scene.deviceState.getCpuUsagePercent()[0] + scene.deviceState.getCpuUsagePercent()[1] + scene.deviceState.getCpuUsagePercent()[2] + scene.deviceState.getCpuUsagePercent()[3] +
     scene.deviceState.getCpuUsagePercent()[4] + scene.deviceState.getCpuUsagePercent()[5] + scene.deviceState.getCpuUsagePercent()[6] + scene.deviceState.getCpuUsagePercent()[7])/8;
