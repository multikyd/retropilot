...
const Rect map_return_btn = {2010, 465, 150, 150};
const Rect map_btn = {1665, 905, 140, 140};
const Rect mapbox_btn = {705, 905, 140, 140};
const Rect rec_btn = {1985, 905, 140, 140};
const Rect laneless_btn = {1825, 905, 140, 140};
const Rect monitoring_btn = {50, 770, 140, 150};
const Rect ml_btn = {1505, 905, 140, 140};
const Rect stockui_btn = {15, 15, 184, 202};
const Rect tuneui_btn = {1960, 15, 184, 202};
const Rect livetunepanel_left_above_btn = {710, 570, 210, 170};
const Rect livetunepanel_right_above_btn = {1480, 570, 210, 170};
const Rect livetunepanel_left_btn = {710, 745, 210, 170};
const Rect livetunepanel_right_btn = {1480, 745, 210, 170};
const Rect speedlimit_btn = {460, 15, 190, 190};
