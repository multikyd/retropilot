...
class Android(HardwareBase):
  ...
  def get_network_type(self):
    wifi_check = parse_service_call_string(service_call(["connectivity", "3"]))
  ...
  def get_thermal_config(self):
    ...
    return ThermalConfig(cpu=((4, 5, 6, 7), 1000), gpu=((8, 9), 1000), mem=(2, 1000),
                         bat=(64, 1000), ambient=(61, 1000), pmic=((21,), 1000))
